...
export const updateOne =  async ({ model, filter ={}, update={} ,options={} } = {}) => {
  const doc = model.updateOne(filter,update,{runValidators:true, new:true, ...options}) 
  return await doc.exec();
}

export const findOneAndUpdateOne =  async ({ model, filter ={}, update={} ,options={} } = {}) => {
  const doc = model.findOneAndUpdateOne(filter,update,{runValidators:true, new:true, ...options}) 
  return await doc.exec();
}
